...
export function AuthProvider({ children }) {
  ...
  return (
    <AuthContext.Provider 
      value={{ 
        currentUser: import.meta.env.DEV ? { uid: 'local-dev', email: 'admin@trafficgenie.local', displayName: 'Local Admin' } : firebaseAuth.currentUser,
        loading: import.meta.env.DEV ? false : firebaseAuth.loading,
